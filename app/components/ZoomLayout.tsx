...
import { ButtonLarge, Controls, MiniMap } from "./zoomLib";
...
export default function ZoomLayout({ width, height }: MainPageProps) {
      ...
      >
        {(zoom) => (
          <div className="relative" style={{ position: "relative" }}>
            ...
            <MiniMap>
              <ButtonLarge onClick={() => setShowMiniMap(!showMiniMap)}>
